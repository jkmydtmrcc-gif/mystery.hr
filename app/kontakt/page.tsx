...
export const metadata = {
  title: "Kontakt | LuxBox",
  description: "Kontaktirajte LuxBox tim - tu smo za sva vaša pitanja i podršku.",
}
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div className="space-y-8">
              <div className="rounded-xl border border-border bg-card p-6">
                ...
                <a href="mailto:info@luxbox.hr" className="mt-2 block text-primary hover:underline">
                  info@luxbox.hr
                </a>
              </div>
              ...
              <div className="rounded-xl border border-border bg-card p-6">
                ...
                <p className="text-muted-foreground">Pon - Pet, 09:00 - 17:00</p>
                <a href="tel:+385123456789" className="mt-2 block text-primary hover:underline">
                  +385 1 234 5678
                </a>
              </div>
              ...
              <div className="rounded-xl border border-border bg-card p-6">
                ...
                <p className="text-muted-foreground">LuxBox d.o.o.</p>
                <p className="text-foreground">Ilica 123, 10000 Zagreb, Hrvatska</p>
              </div>
