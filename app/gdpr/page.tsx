...
export const metadata = {
  title: "GDPR - Zaštita Podataka | LuxBox",
  description: "Informacije o vašim pravima prema GDPR regulativi i kako LuxBox štiti vaše osobne podatke.",
}
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            <section>
              ...
              <p className="text-muted-foreground">
                LuxBox d.o.o. u potpunosti poštuje GDPR regulativu i predani smo zaštiti vaših osobnih podataka.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <div className="rounded-xl border border-border bg-card p-6">
                  ...
                  <p>Email: gdpr@luxbox.hr</p>
                  <p>Telefon: +385 1 234 5678</p>
                  <p>Adresa: LuxBox d.o.o., Ilica 123, 10000 Zagreb</p>
                </div>
                <p>
            ...
            <section>
              ...
              <div className="rounded-xl border border-border bg-card p-6">
                <p className="mb-4 text-muted-foreground">
                  Za podnošenje GDPR zahtjeva, molimo ispunite sljedeće informacije i pošaljite na gdpr@luxbox.hr:
                </p>
