...
export const metadata = {
  title: "FAQ - Česta Pitanja | LuxBox",
  description: "Odgovori na najčešće postavljana pitanja o LuxBox mystery boxovima.",
}
...
const faqs = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Naši boxovi sadrže raznovrsne premium proizvode: modne dodatke, elektroniku, kozmetiku, lifestyle proizvode i više. Svaki box je jedinstven i prilagođen razini (Silver, Gold, Platinum).",
      },
      {
      ...
      },
      {
        ...
        a: "Ne, to je suština mystery boxa - iznenađenje! Međutim, možete odabrati tematske boxove (Tech Box, Fashion Box) koji su fokusirani na određenu kategoriju proizvoda.",
      },
    ],
  },
  {
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
              Pronađite odgovore na najčešće postavljana pitanja o LuxBox mystery boxovima, narudžbama i dostavi.
            </p>
          </div>
