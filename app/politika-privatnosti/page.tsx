...
export const metadata = {
  title: "Politika Privatnosti | LuxBox",
  description: "Saznajte kako LuxBox prikuplja, koristi i štiti vaše osobne podatke.",
}
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  LuxBox d.o.o. (u daljnjem tekstu: "mi", "naš" ili "Tvrtka") posvećena je zaštiti privatnosti svojih
                  korisnika. Ova Politika privatnosti objašnjava kako prikupljamo, koristimo, dijelimo i štitimo vaše
                  osobne podatke kada koristite našu web stranicu luxbox.hr i povezane usluge.
                </p>
                <p>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                <div className="rounded-xl border border-border bg-card p-6">
                  ...
                  <p>OIB: 12345678901</p>
                  <p>Email: privatnost@luxbox.hr</p>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <p>Za ostvarivanje svojih prava, kontaktirajte nas na: privatnost@luxbox.hr</p>
              </div>
            </section>
