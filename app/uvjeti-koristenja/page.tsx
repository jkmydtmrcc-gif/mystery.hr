...
export const metadata = {
  title: "Uvjeti Korištenja | LuxBox",
  description: "Opći uvjeti korištenja web trgovine LuxBox.",
}
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  ...
                  LuxBox (u daljnjem tekstu: Trgovina) koja je u vlasništvu tvrtke LuxBox d.o.o., sa sjedištem na adresi
                  Ilica 123, 10000 Zagreb, Hrvatska, OIB: 12345678901.
                </p>
                <p>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                <ul className="list-disc space-y-2 pl-6">
                  <li>
                    <strong className="text-foreground">Trgovina</strong> - web stranica luxbox.hr i sve njezine
                    podstranice
                  </li>
                  <li>
                    <strong className="text-foreground">Prodavatelj</strong> - LuxBox d.o.o.
                  </li>
                  <li>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <p>
                  Sva kartična plaćanja obrađuju se sigurno putem CorvusPay payment gateway-a. LuxBox d.o.o. ne
                  pohranjuje podatke o karticama kupaca.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <p>
                  Kupac je dužan osigurati točnost podataka za dostavu. LuxBox d.o.o. nije odgovoran za kašnjenja ili
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <ul className="list-disc space-y-2 pl-6">
                  <li>Email: reklamacije@luxbox.hr</li>
                  <li>Telefon: +385 1 234 5678</li>
                  <li>Pisanim putem na adresu sjedišta</li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  LuxBox d.o.o. nije odgovoran za štetu nastalu uslijed više sile, prekida rada sustava, tehničkih
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  LuxBox d.o.o. zadržava pravo izmjene ovih Uvjeta u bilo kojem trenutku. Izmjene stupaju na snagu danom
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <div className="rounded-xl border border-border bg-card p-6">
                  <p>
                    <strong className="text-foreground">LuxBox d.o.o.</strong>
                  </p>
                  <p>Ilica 123, 10000 Zagreb, Hrvatska</p>
                  <p>OIB: 12345678901</p>
                  <p>Email: info@luxbox.hr</p>
