                  ...
                  <CardContent className="p-0">
                    <Link href={`/proizvod/${box.slug}`} className="block">
                      <div className="relative aspect-square overflow-hidden bg-secondary/50">
                        ...
                        {box.stock <= 20 && (
                          <div className="absolute right-1 top-1 z-10 flex items-center gap-0.5 rounded-full bg-destructive px-1 py-0.5">
                        ...
                        <div className="absolute right-1 top-1 z-10 rounded bg-primary px-1 py-0.5">
                          <span className="text-[8px] font-semibold text-primary-foreground sm:text-[10px]">
                            -{discount}%
                          </span>
                        </div>
                    ...
                    <div className="p-1.5 sm:p-3">
                      ...
                      <div className="mb-1.5 flex items-baseline gap-1">
                        ...
                        <span className="text-[8px] text-muted-foreground line-through sm:text-xs">
                          {box.originalPrice}€
                        </span>
                      </div>
