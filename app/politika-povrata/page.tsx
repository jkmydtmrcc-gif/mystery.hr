...
export const metadata = {
  title: "Politika Povrata | LuxBox",
  description: "Saznajte sve o pravu na povrat i procesu vraćanja proizvoda kod LuxBox-a.",
}
          ...
          <div className="prose prose-invert max-w-none space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Pošaljite zahtjev za povrat na povrati@luxbox.hr s brojem narudžbe i razlogom povrata.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <p>
                  <strong className="text-foreground">Oštećenje u transportu:</strong> LuxBox d.o.o. snosi sve troškove,
                  uključujući povratnu pošiljku.
                </p>
                <p>
                  <strong className="text-foreground">Pogrešna isporuka:</strong> LuxBox d.o.o. snosi sve troškove i
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <p>Reklamacije šaljite na: reklamacije@luxbox.hr</p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="rounded-xl border border-border bg-card p-6">
                <p className="mb-2">
                  <strong className="text-foreground">LuxBox d.o.o. - Odjel za povrate</strong>
                </p>
                <p className="text-muted-foreground">Ilica 123, 10000 Zagreb, Hrvatska</p>
                <p className="text-muted-foreground">Email: povrati@luxbox.hr</p>
                <p className="text-muted-foreground">Telefon: +385 1 234 5678</p>
