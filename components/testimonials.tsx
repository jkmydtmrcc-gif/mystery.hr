...
const testimonials = [
  {
    ...
    location: "Zagreb",
    rating: 5,
    text: "Nevjerojatno iskustvo! U Gold Boxu sam dobio sat čija vrijednost premašuje 800€. Definitivno ću opet naručiti!",
    box: "Gold Box",
  ...
  },
  {
    ...
    location: "Split",
    rating: 5,
    text: "Kupila sam Silver Box kao poklon za rođendan. Prijateljica je bila oduševljena - dobila je prekrasnu torbicu i parfem!",
    box: "Silver Box",
  ...
  },
  {
    ...
    location: "Rijeka",
    rating: 5,
    text: "Skeptičan sam bio u početku, ali Platinum Box je premašio sva očekivanja. Premium kvaliteta i vrhunska prezentacija.",
    box: "Platinum Box",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-muted-foreground">
            Pridružite se tisućama zadovoljnih kupaca koji su otkrili magiju LuxBox-a
          </p>
        </div>
