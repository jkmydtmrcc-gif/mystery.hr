...
import { getBoxContentForCategory } from "@/lib/box-content-data"
...
export function ProductDetails({ product }: { product: Product }) {
  ...
  const boxContentItems = getBoxContentForCategory(product.category)
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
            ...
            <div className="space-y-4">
              <div className="relative aspect-square overflow-hidden rounded-2xl border border-border bg-gradient-to-br from-secondary/50 to-background">
                {/* Category badge */}
                ...
                {product.gallery[selectedImage]?.endsWith(".webm") ? (
                  <video
